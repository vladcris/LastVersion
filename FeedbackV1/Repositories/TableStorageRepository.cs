...
namespace FeedbackV1.Repositories
{
    ...
    {
        private CloudTable cardsTable, feedbacksTable, userTable;
        ...
        public async Task<List<Employees>> GetAllEntities()
        {
            ...
            // people = people.Where(x => x.Manager_ID == "1_0008").ToList();
            if (results == null)
                return null;
            return people;
        }
        ...
        public async Task<List<Feedbacks>> GetAllEntities1(string ID)
        {
            await feedbacksTable.CreateIfNotExistsAsync();
